...
Output:
    ...
    Task 2: output files placed in Google Drive folder task2_output
    Task 3: printscreen as problem03.jpg, placed in Google Drive


Note: Because the size of output files is too large, it is placed in Google Drive
Google Drive link: https://drive.google.com/drive/folders/1S1G_0fuweP6bLHRtM5qCshJrzcauhrLe?usp=sharing
